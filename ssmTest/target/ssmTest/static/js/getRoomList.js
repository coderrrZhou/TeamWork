...
<<<<<<< HEAD
                var li = $("<li style='float: left'><div class='roomTitle' onclick='onclick_JoinRoom(this)' thisRoom='"+val.roomId+"' style='float: left;width: 100px; background-color: #FBEC88;margin: 50px 0 0 100px;height: 200px;width: 250px; text-align:center;line-height: 200px;font-size: 20px; font-family: 隶书;'>"+ val.roomId +"进入房间</div></li>");
=======
                // var li = $("<li class='d-flex justify-content-between align-items-center'><div class='roomTitle' onclick='onclick_JoinRoom(this)' thisRoom='"+val.roomId+"' style='float: left;width: 100px; background-color: #FBEC88;margin: 50px 0 0 100px;height: 200px;width: 250px; text-align:center;line-height: 200px;font-size: 20px; font-family: 隶书;'>"+ val.roomId +"进入房间</div></li>");
                var li = $("<li ><div class='roomList tm-bg-black' onclick='onclick_JoinRoom(this)' thisRoom='"+val.roomId+"'>进入"+ val.roomId +"号房间</div></li>");
>>>>>>> gameOver~
>>>>>>> GameOver
